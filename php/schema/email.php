...
class Email
{
    ...
    {
        $url = 'http://192.168.1.18:80/vennture/public/start/?data=' . urlencode($data['data']) . '&token=' . $data['key'];
        $body = '
            <!DOCTYPE html>
            <html lang="es">
            <head>
    ...
    {
        $url = "http://192.168.1.18:80/vennture/public/logs/change_pass/?data=" . urlencode($data['data']) . '&key=' . $data['key'] . '&token=' . $token;
